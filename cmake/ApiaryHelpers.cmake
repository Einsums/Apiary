...
function(apiary_aggregate_extension)
    cmake_parse_arguments(_A ""
        "NAME;MAIN;REGISTER_PREFIX;MODULES_HEADER;MODULES_INCLUDE_DIR;STUBS_TARGET;FRAG_DIR;PKG_DIR;PY_HELPERS_DIR;STUB_OVERLAY;STUB_OVERLAY_CLASS_REGEX;DOCS_TARGET;DOCS_OUTDIR"
    ...
    if(_A_STUBS_TARGET)
        ...
        add_custom_command(
            ...
            DEPENDS "${APIARY_SCRIPTS_DIR}/aggregate_stubs.py" ${_A_STUBS} ${_A_PY_HELPER_DEPENDS} ${_A_STUB_OVERLAY}
